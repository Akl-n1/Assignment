...
namespace Day1_LINQ
{
    class Product : IComparable<Product>
    {
        ...
        public override string ToString()
        {
            return string.Format(
                "ProductID: {0,-4} | ProductName {1,-23} |Category: {2,-15} |UnitPrice: {3,-7:C} |UnitsInStock: {4,-10}",
    ...
    class Customer
    {
        ...
        public override string ToString()
        {
            return string.Format("{0,-5} | {1,-20} | {2,-20} | {3,-15} | {4,-10} | {5,-10} | {6,-15} | {7,-15}",
                Id, Name, Address, City, PostalCode, Country, Phone, Fax);
        }
    }
    class Order
    {
        ...
        public override string ToString()
        {
            return string.Format("{0,-10} | {1,-15} | {2,-10}", Id, OrderDate, Total);
        }
    }
